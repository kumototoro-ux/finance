...
// =====================================================================
// إجراءات: list, getCard, getStatement, setManualStatus, revertToAutomatic,
//           reportOverdue, reportUnpaid, reportExemptions, reportFeesByGradeBranch
//
...
async function handleGetCard(req, res) {
  ...
  return res.status(200).json({
    success: true,
    data: { student, invoices: invoices || [], clearance: clearance || [], totalOutstanding },
  });
}
